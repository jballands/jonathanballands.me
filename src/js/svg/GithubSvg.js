...
export default class GithubSvg extends React.Component {
    ...
    render() {
        return (
            <svg viewBox="0 0 37 31" width={this.props.width} height={this.props.height}>
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <path fill={this.props.color} d="M18.278,0C8.185,0,0,8.185,0,18.278c0,8.077,5.237,14.927,12.501,17.343
